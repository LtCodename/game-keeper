  ...
  return (
    <div className="privacyWrapper">
      <div className="privacy-text">
        <span className="policy-segment-name">Privacy policy</span>
        <span>
          This privacy policy (&quot;Policy&quot;) describes how Website
          Operator (&quot;Website Operator&quot;, &quot;we&quot;, &quot;us&quot;
          or &quot;our&quot;) collects, protects and uses the personally
          identifiable information (&quot;Personal Information&quot;) you
          (&quot;User&quot;, &quot;you&quot; or &quot;your&quot;) may provide on
          the{" "}
          <a
        ...
        <span className="policy-segment-name">
        ...
        <span>
          ...
          an account, or fill any online forms on the Website. When required,
          ...
          of some of the Website's features. Users who are uncertain about what
        ...
        <span>
          ...
          respond to queries and emails of our customers; send notification
          emails such as password reminders, updates, etc; run and operate our
        ...
        <span>
          ...
          following applies: &bull; You have given your consent for one or more
          ...
          protection law; &bull; Provision of information is necessary for the
          performance of an agreement with you and/or for any pre-contractual
          obligations thereof; &bull; Processing is necessary for compliance
          with a legal obligation to which you are subject; &bull; Processing is
          related to a task that is carried out in the public interest or in the
          exercise of official authority vested in us; &bull; Processing is
          necessary for the purposes of the legitimate interests pursued by us
          or by a third party. In any case, we will be happy to clarify the
        ...
        <span>
          ...
          document or inquire with us using the information provided in the
          contact section.
        </span>
        <span className="policy-segment-name">The rights of users</span>
        <span>
          You may exercise certain rights regarding your information processed
          by us. In particular, you have the right to do the following: &bull;
          you have the right to withdraw consent where you have previously given
          your consent to the processing of your information; &bull; you have
          the right to object to the processing of your information if the
          processing is carried out on a legal basis other than consent; &bull;
          ...
          obtain a copy of the information undergoing processing; &bull; you
          have the right to verify the accuracy of your information and ask for
          it to be updated or corrected; &bull; you have the right, under
          certain circumstances, to restrict the processing of your information,
          in which case, we will not process your information for any purpose
          other than storing it; &bull; you have the right, under certain
          circumstances, to obtain the erasure of your Personal Information from
          us; &bull; you have the right to receive your information in a
        ...
        <span className="policy-segment-name">Privacy of children</span>
        <span>
          ...
          Website, including gamekeeper.ltcodename.com. We believe parents
          should be involved in the online activities of their children and
          suggest that parents do their best to provide their children with a
          safe and friendly online environment.
        </span>
        <span className="policy-segment-name">Cookies</span>
        <span>
        ...
        <span className="policy-segment-name">Do Not Track signals</span>
        <span>
          ...
          websites over time. Our Website does not track its visitors over time
        ...
        <span className="policy-segment-name">Links to other websites</span>
        <span>
        ...
        <span className="policy-segment-name">Information security</span>
        <span>
          ...
          &bull; there are security and privacy limitations of the Internet
          which are beyond our control; &bull; the security, integrity, and
          privacy of any and all information and data exchanged between you and
          our Website cannot be guaranteed; and &bull; any such information and
          data may be viewed or tampered with in transit by a third-party,
          despite best efforts.
        </span>
        <span className="policy-segment-name">Data breach</span>
        <span>
        ...
        <span className="policy-segment-name">Legal disclosure</span>
        <span>
        ...
        <span className="policy-segment-name">Changes and amendments</span>
        <span>
          ...
          treat Personal Information. When changes are made, we will send you an
          email to notify you. We may also provide notice to you in other ways
          in our discretion, such as through contact information you have
          provided. Any updated version of this Privacy Policy will be effective
          immediately upon the posting of the revised Privacy Policy unless
          otherwise specified. Your continued use of the Website or Services
          after the effective date of the revised Privacy Policy (or such other
        ...
        <span className="policy-segment-name">Acceptance of this policy</span>
        <span>
        ...
        <span className="policy-segment-name">Contacting us</span>
        <span>
        ...
        <span>This document was last updated on September 30, 2019.</span>
      </div>
    </div>
  );
};
